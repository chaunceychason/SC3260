...
//**********************************************************************
void update_positions( Atoms * myatoms, const misc_params * m_pars, int * scounts, int * displs,int rank, int nprocs )
{
   ...
   for ( atomi = displs[rank]; atomi < (displs[rank]+scounts[rank]); atomi++ )
   {
   ...
   /*
   MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,myatoms->xx,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
   MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,myatoms->yy,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
   MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,myatoms->zz,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
   */
}
...
//**********************************************************************
void update_velocities( Atoms * myatoms, const misc_params * m_pars, int *scounts, int *displs,int rank, int nprocs )
{
   ...
   int atomi;
   float const_fac = 0.5 * m_pars->xmassi * m_pars->dt;
   //OLD: for ( atomi = 0; atomi < myatoms->N; atomi++ )
   for ( atomi = displs[rank]; atomi < (displs[rank]+scounts[rank]); atomi++ )
   {
   ...
   /*
   MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,myatoms->vx,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
   MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,myatoms->vy,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
   MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,myatoms->vz,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
   */
   timeit(2,1);
