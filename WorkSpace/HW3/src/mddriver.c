...
void driver(const int arg_count, char ** arg_list, int nprocs, int rank)
{
   ...
   for (istep=0; istep <= cl.n_timesteps; istep++)
   {
      ...
      update_positions( &atoms, &mp, scounts, displs, rank, nprocs ); // update particle positions for next timestep.
      MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,atoms.xx,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
      MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,atoms.yy,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
      MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,atoms.zz,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
      ...
      update_velocities( &atoms, &mp, scounts, displs, rank, nprocs); // update particle velocities for next timestep

      
      MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,atoms.vx,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
      MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,atoms.vy,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
      MPI_Allgatherv(MPI_IN_PLACE,0,MPI_FLOAT,atoms.vz,scounts,displs,MPI_FLOAT,MPI_COMM_WORLD);
